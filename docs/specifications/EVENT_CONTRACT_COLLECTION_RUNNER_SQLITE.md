...
T3C is implemented, committed, and pushed as `47a7a45df7dd9ad03e996389aaa2cc8b394aa699`; see [Event Contract Collection Runner SQLite Recovery](EVENT_CONTRACT_COLLECTION_RUNNER_SQLITE_RECOVERY.md).
