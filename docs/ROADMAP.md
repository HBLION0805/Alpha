...
13. **Day15-T3B10 — Forward Collection Pilot**
   ...
   - T3B15 next sequence: Owner review of MR4, commit/push only after approval, then T3B15-C4 and an independent T3B15-MR5. One exact rehearsal remains blocked unless MR5 explicitly returns `GO_FOR_ONE_EXACT_NETWORK_FREE_REHEARSAL`.
