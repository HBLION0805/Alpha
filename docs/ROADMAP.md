...
13. **Day15-T3B10 — Forward Collection Pilot**
   ...
   - T3B15-MR3 status: complete locally and pending Owner review; decision `NO_GO_FOR_ONE_EXACT_NETWORK_FREE_REHEARSAL`.
   ...
   - T3B15 next sequence: Owner review of MR3, commit/push only after approval, then T3B15-C3 and an independent T3B15-MR4. One exact rehearsal remains blocked unless MR4 explicitly returns `GO_FOR_ONE_EXACT_NETWORK_FREE_REHEARSAL`.
