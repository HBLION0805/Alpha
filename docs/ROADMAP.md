...
13. **Day15-T3B10 — Forward Collection Pilot**
   ...
   - T3B15-MR2 status: independent review complete locally and pending Owner review; decision `NO_GO_FOR_ONE_EXACT_NETWORK_FREE_REHEARSAL`.
   ...
   - T3B15 next sequence: Owner review of MR2, then T3B15-C2 correction and a new independent T3B15-MR3. One exact rehearsal remains blocked unless a later review explicitly returns `GO_FOR_ONE_EXACT_NETWORK_FREE_REHEARSAL`.
