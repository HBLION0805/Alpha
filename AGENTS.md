...
- Treasury daily real-yield context: five tenors, bounded anonymous current-month XML GET, exact source/actual retrieval clocks, fixed failure codes, separate checksum-linked journal and correction-preserving restart recovery. The active shared daily baseline is v5; v1/v2/v3/v4 snapshots and the frozen opening quote study remain immutable. See docs/OPTIONS_TREASURY_REAL_YIELDS_DELIVERY.md. No automatic orders or strategy signal.
