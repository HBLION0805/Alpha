...
export async function runGuidanceCommand(args,{workspaceRoot=process.cwd(),now=()=>new Date().toISOString()}={}) {
  ...
  if(["--report","--publish","--host-brief","--delivery-health"].includes(mode)&&args.length===1) {
