...
await test('context export and frontend module are wired',()=>{assert(readFileSync('apps/options-workbench/app.js','utf8').includes('context:{goldFramework:state.goldFramework'));assert(readFileSync('apps/options-workbench/focused-news.js','utf8').includes('goldFrameworkPanel(s.goldFramework)'));});
