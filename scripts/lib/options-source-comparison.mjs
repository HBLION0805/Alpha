...
export function readSourceRecord(root,path){
  if(typeof path!=='string'||!/^data\/runtime\/options-macro-comparisons\/source-(?:package|draft|saved|expectation|scenario|prediction|outcome|review|journal)-[a-z0-9][a-z0-9-]{2,79}\.json$/.test(path))fail('PATH');
