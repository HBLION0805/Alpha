...
const requiredFiles = [
  ...
  "docs/OPTIONS_ROBINHOOD_HEARTBEAT_PHASES.json",
  "docs/OPTIONS_ROBINHOOD_HEARTBEAT_RESTORE.json",
  "docs/OPTIONS_ROBINHOOD_HEARTBEAT_PROMPT.txt",
  "docs/status/robinhood-autocollection.json",
  ...
  "docs/specifications/OPTIONS_NEWS_INFRASTRUCTURE.md",
...
const aggregateTestFiles = [
  ...
  "scripts/options-position-watch.test.mjs",
    "scripts/options-position-quotes.test.mjs",
    "scripts/options-source-comparison.test.mjs",
    "scripts/options-market-expectation.test.mjs",
  ...
  "scripts/options-bar-quality.test.mjs",
  ...
  "scripts/options-sample-inventory.test.mjs",
  "src/engines/options-structure-comparison/OptionsStructureComparisonEngine.test.ts",
  ...
  "scripts/options-dashboard.test.mjs",
  "src/engines/options-readiness/OptionsCalendarBrief.test.ts",
  "scripts/options-calendar-brief.test.mjs",
  ...
  "scripts/options-evidence-rehearsal.test.mjs",
  ...
  "src/engines/options-news/OptionsNewsPersistenceBudgetHealth.test.ts",
  "src/engines/options-news/OptionsNewsEndToEnd.test.ts",
