...
Day 8 Intelligence foundations through Day15-T3B13-MR1 are complete and pushed. Day13-T2/T3 adds a deterministic BTC 15-minute Event Analyzer console prototype with bounded PT1M candle features, Day14-T1 adds the provider-independent Capital Allocation Framework v1.0 construction boundary, Day15-T1/T2 adds immutable event-contract observations and an append-only shadow ledger, Day15-T3A/T3B adds research-integrity and dataset-qualification gates, and T3B2 through T3B8 build exact offline/forward collection and reviewed fixture/live-read source foundations. Day15-T3B9 through T3B13 build and drill the durable SQLite, authenticated recovery, fixture runtime, one-action assembly, strict fixture-rehearsal authority, isolated preparation, bounded evidence packaging, and package-level crash foundations while keeping operation blocked. T3B14-T1 is complete locally as a design: it defines the missing rehearsal-profile durable registry, exact one-phase Owner invocation, ambiguity reconciliation, online-backup evidence envelope, fixed validation evidence, fresh-process verification, and end-to-end process drills. It adds no implementation or rehearsal-run authority.
