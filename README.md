...
Day 8 Intelligence foundations through Day15-T3B7 are complete and pushed. Day13-T2/T3 adds a deterministic BTC 15-minute Event Analyzer console prototype with bounded PT1M candle features, Day14-T1 adds the provider-independent Capital Allocation Framework v1.0 construction boundary, Day15-T1/T2 adds immutable event-contract observations and an append-only shadow ledger, Day15-T3A/T3B adds research-integrity and dataset-qualification gates, Day15-T3B2 adds exact offline shadow-dataset assembly, Day15-T3B3 adds deterministic forward collection control, Day15-T3B4 adds its local operator surface, Day15-T3B5 defines real collection-source admission, and Day15-T3B6 implements provider-neutral source contracts. A local Day15-T3B7 correction now combines the official Kalshi fixture with the exact public Robinhood event page and content-addressed `CRYPTO15M` terms to create one reviewed mapping and fixture settlement snapshot; it is pending owner review.
