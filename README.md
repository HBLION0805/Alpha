...
The T3B10-T3A implementation boundary is specified in [Event Contract Collection Runner SQLite Dependency and Migration](docs/specifications/EVENT_CONTRACT_COLLECTION_RUNNER_SQLITE_MIGRATION.md). It implements safe local store opening and migration 001 only; repository transactions and runner operation remain deferred.
