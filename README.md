...
Day 8 Intelligence foundations through Day15-T3B14-T4 are complete and pushed. Day13-T2/T3 adds a deterministic BTC 15-minute Event Analyzer console prototype with bounded PT1M candle features, Day14-T1 adds the provider-independent Capital Allocation Framework v1.0 construction boundary, Day15-T1/T2 adds immutable event-contract observations and an append-only shadow ledger, Day15-T3A/T3B adds research-integrity and dataset-qualification gates, and T3B2 through T3B8 build exact offline/forward collection and reviewed fixture/live-read source foundations. Day15-T3B9 through T3B13 build and drill the durable SQLite, authenticated recovery, fixture runtime, one-action assembly, strict fixture-rehearsal authority, isolated preparation, bounded evidence packaging, and package-level crash foundations while keeping operation blocked. T3B14-T1 designs durable rehearsal composition, T3B14-T2 provides its closed contracts and Migration 003 profile, T3B14-T3 adds the durable PREPARE/STEP/RECOVER coordinator, and T3B14-T4 adds the fixed validation, terminal freeze, online backup, immutable envelope, and independent verifier. T3B14-T5 is complete locally with fresh-process build/verify, publication-crash, substitution, missing-backup, source-isolation, and two-run drills. It adds no executable command, real rehearsal run, network provider, real Pilot, T1/T2 delivery, recommendation, or trading authority.
