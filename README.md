...
Day 8 Intelligence foundations through Day14-T1 are complete and pushed. Day13-T2/T3 adds a deterministic BTC 15-minute Event Analyzer console prototype with bounded PT1M candle features, and Day14-T1 adds the provider-independent Capital Allocation Framework v1.0 construction boundary. Day15-T1 locally adds the first immutable BTC event-contract observation boundary with exact settlement semantics, quotes, fee previews, evidence binding, and fee-inclusive break-even arithmetic; it is pending owner review.
