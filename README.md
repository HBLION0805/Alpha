...
`npm test` runs the complete deterministic TypeScript suite, including the focused Strategy Versioning, Development Validation Log, Historical Pattern Library, Historical Analogy Engine, and Event Replay suites.
