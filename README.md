...
The current Runner readiness decision is recorded in [Event Contract Collection Runner Milestone Review](docs/EVENT_CONTRACT_COLLECTION_RUNNER_MILESTONE_REVIEW.md). The separately gated fixture-runtime sequence is defined in [Event Contract Collection Runner Runtime Architecture](docs/specifications/EVENT_CONTRACT_COLLECTION_RUNNER_RUNTIME.md).
